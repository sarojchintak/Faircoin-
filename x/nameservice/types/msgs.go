...
// MsgSendMoneydefines the SendCoins message
...
// NewMsgBuyName is the constructor function for MsgBuyName
func NewMsgSendMoney(name string, amount sdk.Coins, buyer sdk.AccAddress) MsgSendMoney {
	return MsgSendMoney{
		Name:  name,
		Amount:   amount,
		Buyer: buyer,
...
// Type should return the action
func (msg MsgSendMoney) Type() string { return "buy_name" }
